...
class AnswerCommentControllerTest extends RestDocumentTest {
    ...
    void successCreate() throws Exception {
        ...
        when(answerCommentService.create(new AnswerCommentRequest())).thenReturn(new IdResponse<>(5L));
        // when
        ...
        // docs
        perform.andDo(print())
                .andDo(document("create answer-comment", getDocumentRequest(), getDocumentResponse()));
    }
}
